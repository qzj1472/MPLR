...
for /f "usebackq delims=" %%i in (`powershell -NoLogo -NoProfile -Command "$props = [xml](Get-Content '..\Directory.Build.props'); $props.Project.PropertyGroup.VersionPrefix"`) do @set version=%%i
